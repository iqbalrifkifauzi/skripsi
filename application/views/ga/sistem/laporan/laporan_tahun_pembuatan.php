					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Cetak Laporan Kebutuhan SPTRD</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<div class="form-horizontal">
									...
									<!-- <div class="control-group">
												<label class="control-label">Objek Retribusi <input type="checkbox" name="status" id="status" value="status"></label>
												...
												<div class="controls">
													<select id="select2_sample33" name="status_kendaraan" class="span6 select2">
														...
														<option value="0">apartemen</option>
